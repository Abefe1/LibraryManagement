...
//    }
    ...
    public String addBorrowedBook(Integer id, String isbn) {
        ...
        Book borrowed = bookRepository.findBookByIsbn(isbn).orElseThrow(
    ...
    public String returnBorrowedBook(String isbn) {
        BorrowedBooks toBeReturned = borrowedBooksRepository.findBorrowedByIsbn(isbn).orElseThrow(() ->
...
//
    ...
    public ResponseEntity<Book> findBookByTitle(String title){
        return ResponseEntity.ok(bookRepository.findBookByTitle(title).orElseThrow(
